            ...
            >
                <div className="text-center mb-12">
                    <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-primary/10 mb-6 border border-primary/20 shadow-xl shadow-primary/5"
                    >
                    ...
                    <p className="text-slate-400 font-medium italic">Authorize your session to continue</p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <motion.button
                        ...
                        type="submit"
                        disabled={loading}
                        className="w-full py-5 rounded-2xl btn-primary text-white font-black text-xl flex items-center justify-center gap-3 disabled:opacity-50"
                    >
                        {loading ? (
